...
# $STANDARD : standard file; the 2d plots will be scaled to the maximum of
# the real part of this spec.

# $SCALE : scaling factor for graphs; data points will be divided by 
# this factor before the plot

#STANDARD=three_0000-2d.dat
...
# comment out the following lines if a common standard scale is needed
STANDARD=$i
SCALE=`2danalysis rmax ${STANDARD} | grep 'Maximum real part' | cut -d'=' -f2 | tr -d ' '`
echo "Will scale ${SCALE} to 1.0"
