...
splot '${i}' u 1:2:(\$3/$SCALE*4)
unset surface
splot '${i}' u 1:2:(\$3/$SCALE*4) w l lw 0.3 lc rgb "#666666"

unset multiplot

EOF

eps2eps ${bname}_mapx4.eps $$.aaa.eps
mv $$.aaa.eps ${bname}_mapx4.eps
